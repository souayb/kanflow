-- Idempotent backfill for databases that ran an older `20260427120000_seed_demo.sql`
-- before `project_members`, extra tasks, dependencies, time entries, or explicit comment id existed.
...
INSERT INTO columns (id, project_id, title, sort_order) VALUES
